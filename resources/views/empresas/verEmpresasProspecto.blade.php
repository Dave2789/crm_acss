            ...
            <div class="container-fluid">
                               ...
                               <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-12 mt-4">
                                         <button type="button" class="dt-button buttons-excel buttons-html5 btn btn-primary mr-1" id="search_bussines_prospect">Buscar</button>
                                        </div>
                                      </div>
                                </div>  
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Empresas prospectos</h4>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="table-responsive m-t-20" id="activeEmpDiv">
                                                <div class="dt-buttons">
                                                     ...
                                                     <div id="activeEmp_filter" class="dataTables_filter">
                                                         <label>Buscar:<input id="seacrhBussines" data-id="3" type="search" class="form-control form-control-sm" placeholder="" aria-controls="activeEmp">
                                                        </label>
                                                    </div>
                                            ...
                                            <td><span class="badge badge-warning badge-pill">Prospecto</span> </td>
                                                          ...
                                                          <td>
                                                           <span class="label label-success">{!! $infoQuotation[$item->pkBusiness]["salesPay"] !!} </span> 
                                                           <span class="label label-danger"> {!! $infoQuotation[$item->pkBusiness]["salesLoss"] !!}</span> </td>
                                                            <td>    
                                                 
                                                        <span class="label label-info"> {!! $infoQuotation[$item->pkBusiness]["quotations"] !!}</span></td>
                                            <td>  
                                                <span class="label label-success">{!! $infoQuotation[$item->pkBusiness]["oportunityAproved"] !!}</span>
                                               <span class="label label-info"> {!! $infoQuotation[$item->pkBusiness]["oportunityOpen"] !!}</span>
                                                 <span class="label label-danger"> {!! $infoQuotation[$item->pkBusiness]["oportunityLoss"] !!}</span>
                                              </td>
                                              <td>
