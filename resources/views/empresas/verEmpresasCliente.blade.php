                               ...
                               <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-12 mt-4">
                                         <button type="button" class="dt-button buttons-excel buttons-html5 btn btn-primary mr-1" id="search_bussines_clients">Buscar</button>
                                        </div>
                                      </div>
                                </div>  
                                    </div>
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="dt-buttons">
                                            <button type="button" data-id="9" class="dowloadExcel dt-button buttons-excel buttons-html5 btn btn-primary mr-1" tabindex="0" aria-controls="activeEmp">
                                                <span>Excel</span>
                                            </button> 
                                        </div>
                                         <div id="activeEmp_filter" class="dataTables_filter">
                                             <label>Buscar:<input id="seacrhBussines" data-id="9" type="search" class="form-control form-control-sm" placeholder="" aria-controls="activeEmp">
                                            </label>
                                        </div>
