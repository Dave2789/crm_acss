<div class="modal-content">
    <div class="modal-header">
        <h2 class="modal-title" id="modalAgentesCLabel">Oportunidades abiertas</h2>
         ...
         <table id="tableSales" class="table display table-bordered table-striped no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Monto</th>
                                                <th>Presupuesto</th>
                                                 <th>Convertir<br>a cotización</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><buttom class="btn-primary btn-sm convertToQuotation"  data-id="{{ $item->pkOpportunities}}"><span class="ti-write"> </span></buttom></td>
                                                @else
