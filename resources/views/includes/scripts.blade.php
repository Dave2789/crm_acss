<!-- ============================================================== -->
    ...
    <script src="{{asset('assets/node_modules/chartist-js/dist/chartist-init.js')}}"></script>
    <!-- Chart JS -->
    ...
    <script src="{{asset('assets/js/pages/morris-data.js')}}"></script>
    ...
    <script src="{{asset('assets/js/pages/flot-data.js')}}"></script>
    <!-- This is data table -->
    <script src="{{asset('assets/node_modules/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('assets/node_modules/datatables.net-bs4/js/dataTables.responsive.min.js')}}"></script>

    <script src="{{asset('assets/node_modules/datatables.net/js/dataTables.buttons.min.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/buttons.flash.min.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/jszip.min.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/pdfmake.min.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/vfs_fonts.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/buttons.html5.min.js')}}" ></script>
    <script src="{{asset('assets/node_modules/datatables.net/js/buttons.print.min.js')}}" ></script>
    <!-- EASY PIE CHART JS -->
    ...
    <script src="{{asset('assets/js/append.js')}}"></script>
    <script src="{{asset('assets/js/appendCompany.js')}}"></script>
    <script type="text/javascript">
        $(function () {
