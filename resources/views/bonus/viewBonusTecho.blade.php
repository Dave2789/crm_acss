            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Ver bonus rompe techo</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Bonus</a></li>
                                <li class="breadcrumb-item active">Bonus rompe techo</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bonus rompe techo</h4>
                                 <div class="row">  
                                  
                                      <div class="col-6 m-t-30">
                                       <select class="form-control custom-select" id="yearTecho" data-placeholder="Selecciona la Actividad" tabindex="1">
                                      ...
                                      <div class="col-12 text-right mt-2"> 
                                         <button type="button" class="dt-button buttons-excel buttons-html5 btn btn-primary mr-1" id="searchBonusTecho">Buscar</button>
                                    </div>
                                 </div>
