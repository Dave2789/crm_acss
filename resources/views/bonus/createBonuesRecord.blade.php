            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Configurar Bono Record</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Configurar Bono Record</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <form action="#">
                                ...
                                <div class="form-actions text-center">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-success" id="btn_addBonRecord"> <i class="fa fa-check"></i> Agregar</button>
                                    </div>
                                </div>
                        </div>
</form>
