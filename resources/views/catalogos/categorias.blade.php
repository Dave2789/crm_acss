                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="f-right mb-3">
                                    <button type="button" data-toggle="modal" data-target="#modalCrearCategoría" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Crear nueva</button>
                                </div>
                                <div class="table-responsive m-t-40">
                                    <table id="oporNeg" class="table display table-bordered table-striped no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{html_entity_decode($categoriesInfo->name)}}</td>
                                                <td>
                                                    <button class="btn btn-info btn-sm btn_updateCategory" data-id="{{$categoriesInfo->pkCategory}}"><span class="ti-pencil"></span></button>
                                                    <button class="btn btn-danger btn-sm btn_deleteCategory" data-id="{{$categoriesInfo->pkCategory}}"><span class="ti-close"></span></button>
                                                </td>
                                            </tr>
                                            @endforeach
      ...
      <div class="modal-dialog modal-abrevius" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title" id="modalAgentesCLabel">Nueva categoría</h2>
                ...
                <div class="row pt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="nameAddCategory" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12 text-right">
                        <button class="btn btn-success btn_addcategory"><span class="ti-check"></span> Crear</button>
                    </div>
                </div>
