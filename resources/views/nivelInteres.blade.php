            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Empresas por Nivel de Interés</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                                <li class="breadcrumb-item active">Empresas por Nivel de Interés</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <h3 class="title-section">Empresas en <i>Nivel de Interés 1</i> de Junio 2019</h3>
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-hover no-wrap" id="empresaNivelInteres">
                                    <thead>
                                        <tr>
                                            <th>Empresa</th>
                                            <th>Contacto</th>
